...
@InputType()
class SubmissionCreateNestedManyWithoutPuzzlesInput {
...
export { SubmissionCreateNestedManyWithoutPuzzlesInput as SubmissionCreateNestedManyWithoutPuzzlesInput };
