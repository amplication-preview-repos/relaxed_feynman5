...
@InputType()
class SubmissionCreateNestedManyWithoutStudentsInput {
...
export { SubmissionCreateNestedManyWithoutStudentsInput as SubmissionCreateNestedManyWithoutStudentsInput };
