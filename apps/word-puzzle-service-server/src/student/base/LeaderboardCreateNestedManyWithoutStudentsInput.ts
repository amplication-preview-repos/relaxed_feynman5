...
@InputType()
class LeaderboardCreateNestedManyWithoutStudentsInput {
...
export { LeaderboardCreateNestedManyWithoutStudentsInput as LeaderboardCreateNestedManyWithoutStudentsInput };
